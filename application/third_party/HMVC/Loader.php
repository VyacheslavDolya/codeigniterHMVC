...
class HMVC_Loader extends CI_Loader
{
    ...
    public function module($moduleName)
    {
        ...
        if (!isset($this->_ci_modules[$moduleName])) {
            $this->_ci_modules[$moduleName] = new Module($moduleName, $modulePath);
            parent::add_package_path($modulePath);
        }

        return $this->_ci_modules[$moduleName];
    }
}
